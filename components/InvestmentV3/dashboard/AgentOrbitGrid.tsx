...
export const AgentOrbitGrid = () => {
    ...
    const agents: Agent[] = [
        ...
        { id: 1, name: "٠١ فهم النشاط التجاري", desc: "يفهم نشاطكم وعروضكم ويصيغ ميزتكم التنافسية بدقة.", kpi: "دقة استيعاب الهوية ١٠٠٪", benefit: "هوية متناسقة ومقنعة في السوق", category: "data", position: { x: 78, y: 6 }, metricId: "leads" },
        { id: 2, name: "٠٢ تحليل السوق والقطاعات", desc: "يرصد حجم الطلب والقطاعات الأكثر احتياجاً لخدماتكم بالسوق.", kpi: "كشف +٥ قطاعات واعدة شهرياً", benefit: "توجيه ذكي لميزانيات الحملات", category: "data", position: { x: 64, y: 10 }, metricId: "leads" },
        { id: 3, name: "٠٣ تحليل وتقييم الفرص", desc: "يقيم المشاريع والصفقات المطروحة لتحديد ربحيتها وملائمتها.", kpi: "فرز +٥٠ صفقة شهرياً وتقييمها", benefit: "تركيز الموارد على الصفقات الأسهل حسمًا", category: "data", position: { x: 50, y: 6 }, metricId: "leads" },
